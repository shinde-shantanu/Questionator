  ...
  100% {
	...
	<script type="text/javascript">
		function generateOptions(){
			...
			var params = 'answer=' + document.getElementById("optionInput").value;
					...
					<section class="newsletter-section">
						<div class="container">
							...
							<div class="newsletter-form">
								<input type="text" placeholder="Enter word for option" id="optionInput">
								<br><br><br>
								<button class="site-btn" onclick="generateOptions();">Generate question  <img src="img/icons/double-arrow.png" alt="#"/></button>
							</div>
						</div>
					</section>
