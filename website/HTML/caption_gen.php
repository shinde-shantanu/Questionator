  ...
  100% {
	...
	<script type="text/javascript">
		function generateCaption(){
			...
			var params = 'url=' + document.getElementById('captionImageUrl').value;
			document.getElementById('captionImage').src = document.getElementById('captionImageUrl').value;
			...
			http.onreadystatechange = function() {
			    if(http.readyState == 4 && http.status == 200) {
			        ...
			        var genCaption = data['success']['data'];
			      	var output=""
			      	for(ele of genCaption){
			      		if(ele!='.'){
			      			output = output + ele;
			      		}
			      	}
			        document.getElementById('caption').innerHTML = output;
		...
		<div class="container">
			<div class="row">	
				<div class="col-xl-12 col-lg-12 col-md-12">
					<section class="newsletter-section">
						<div class="container">
							...
							<div class="newsletter-form">
								<input type="text" placeholder="ENTER IMAGE URL" id="captionImageUrl">
								<br><br><br>
								<button class="site-btn" onclick="generateCaption();">Generate Caption  <img src="img/icons/double-arrow.png" alt="#"/></button>
							</div>
						</div>
					</section>
					...
					<div id='captionLoadingDiv' style="display: none;padding-top:15px;">
						<h3 style="text-align: center; color:white">Generating caption</h3>
						<div class="bar"></div>
					</div>
					<br><br><br>
					<div id='captionDiv' style="display: none;">
						<h3 style="text-align: center;color:white;margin-top: 15px">Generated caption:</h3>
						<br><br>
						<h3 id='caption' style="color: white;text-align: center"></h3>
					</div>
						</div>
