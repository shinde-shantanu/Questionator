...
<body>
	...
	<header class="header-section">
		<div class="header-warp">
			<!--s="header-social d-flex justify-content-end">
				<p>Follow us:</p>
			...
			<div class="header-bar-warp d-flex">
				<!-- site logo -->
				<a href="home.php" class="site-logo" style="margin-top: 0px; padding: 0px;">
					<img src="./img/questionlogo_small.jpg" width = "150px" height = "150px" alt="" style="margin-top:-25px;">
				</a>
				<nav class="top-nav-area w-100" style="font-size: 30px">
	...
	<section class="hero-section overflow-hidden">
		<div class="hero-slider owl-carousel">
			<div class="hero-item set-bg d-flex align-items-center justify-content-center text-center" data-setbg="img/slider-bg-1.jpg">
				<div class="container">
					<h2>Questionator.ai</h2>
					<p>Powered by artificial intelligence and machine learning algorithms, Questionator is a platform that lets you build a host of quality quizzes and assessments—within seconds.<br>Explore the true potential of questions, with Questionator.</p>
					</div>
			</div>
			<div class="hero-item set-bg d-flex align-items-center justify-content-center text-center" data-setbg="img/slider-bg-2.jpg">
				<div class="container">
					<h2>Select your Domain</h2><br>
					<a href="sports.php" class="site-btn" style="margin-right: 30px;">Sports<img src="img/icons/double-arrow.png" alt="#"/></a>
					<a href="wildlife.php" class="site-btn" style="margin-right: 30px;">wildlife<img src="img/icons/double-arrow.png" alt="#"/></a>
					<a href="Entertainment.php" class="site-btn" style="margin-right: 30px;">Entertainment<img src="img/icons/double-arrow.png" alt="#"/></a>
					<a href="vehicle.php" class="site-btn" style="margin-right: 30px;">Vehicles<img src="img/icons/double-arrow.png" alt="#"/></a>
				</div>
			</div>
		</div>
	</section>
		...
		-->
			<footer class="page-footer font-small">
				<div class="footer-copyright text-center py-3">
					<a href="">M-vision © 2019 Copyright</a>	
				</div>
